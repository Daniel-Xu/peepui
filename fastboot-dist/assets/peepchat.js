...
define('peepchat/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"peepchat","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"peepchat","version":"0.0.0+b725a3c5"},"DS":{"host":"http://localhost:4000","namespace":"api"},"exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("peepchat/app")["default"].create({"name":"peepchat","version":"0.0.0+b725a3c5"});
}
